...
const BlogInfoDateIcon = styled(TodayIcon)`
    margin: auto 5px auto 0px;
    font-size: 1rem;
    color: ${brandColors.green};
`

const BlogInfoDotIcon = styled(FiberManualRecordIcon)`
...
const BlogInfoTimeIcon = styled(ScheduleIcon)`
    margin: auto 5px auto 0px;
            ...
            <GeneralCard>
                <UnstyledGatsbyLink to={blogPost.url}>
                    <BlogCardContent className={direction}>
                        ...
                        <span>
                            {RichText.asText(blogPost.data.subtitle.richText)}
                        </span>
