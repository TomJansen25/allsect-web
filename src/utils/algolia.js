...
const processPost = (post) => {
    const title = RichText.asText(post.dataRaw.title)
    const subtitle = RichText.asText(post.dataRaw.subtitle)
...
function processRecipe(recipe) {
    const title = RichText.asText(recipe.dataRaw.title)
    const subtitle = RichText.asText(recipe.dataRaw.subtitle)
    const intro = RichText.asText(recipe.dataRaw.introduction)
    const ingredients = RichText.asText(recipe.dataRaw.ingredients)
    const prep = RichText.asText(recipe.dataRaw.prep)
...
const queries = [
    /*
    {
        ...
        settings,
        matchFields: ["title", "content", "description", "source", "url"],
    },
    */
    {
        query: BlogPostQuery,
