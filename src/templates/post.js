...
import ReadingProgress from "../components/navbar/readingProgress"
...
const PostTemplate = ({ data }) => {
    ...
    return (
        <section ref={target}>
            <SEO
                title={RichText.asText(post.title.richText)}
            ...
            <PostHeaderWrapper>
                <PostHeader>
                    ...
                    <InfoRow>
                        <TodayIcon className={"first-icon"} />
                        ...
                        <ScheduleIcon className={"last-icon"} />
                    </InfoRow>
                </PostHeader>
            </PostHeaderWrapper>
